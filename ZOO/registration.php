...
$check_email_query2="select * from users WHERE user_name='$user_name'";
    $run_query2=mysqli_query($dbcon,$check_email_query2);

    if(mysqli_num_rows($run_query2)>0)
    {
echo "<script>alert('Name $user_name already exist in our database, Please try another one!')</script>";
exit();
